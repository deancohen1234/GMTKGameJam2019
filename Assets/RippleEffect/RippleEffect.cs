...
public class RippleEffect : MonoBehaviour
{
    ...
    public void ActivateRipple(Vector3 location)
    {
        Vector2 screenPos = GetComponent<Camera>().WorldToScreenPoint(location);
        screenPos.x /= GetComponent<Camera>().pixelWidth;
        screenPos.y /= GetComponent<Camera>().pixelHeight;
